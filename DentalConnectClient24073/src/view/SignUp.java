...
public class SignUp extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/view/newTeeth (2).jpg"))); // NOI18N
                ...
                if(passField.getPassword().length>=8 && passField.getPassword().length<=16){
                    if(String.valueOf(passField.getPassword()).equals(String.valueOf(passField.getPassword())))
                    {
                        try{
                            ...
                            user.setFirst_name(firstNameTxt.getText());
                            user.setLast_name(lastNameTxt.getText());
                            user.setEmail(emailTxt.getText());
                            user.setPhone_number(phonetxt.getText());
