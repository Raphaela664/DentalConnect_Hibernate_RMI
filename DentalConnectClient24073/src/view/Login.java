...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 120, 250, 290));
    ...
    private void loginBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginBtnActionPerformed
        ...
        if(
            ...
            JOptionPane.showMessageDialog(this,"Pease fill all the input fields!","Data required",JOptionPane.WARNING_MESSAGE);
                            ...
                            Users FoundUser = intrf.loginUser(user);
                                if(FoundUser!=null){
                                    if((FoundUser.getUser_role()).equals("USER")){
                                     JOptionPane.showMessageDialog(this,"Login successful");
                                     UserDashboard page = new UserDashboard(FoundUser);
                                     dispose();
